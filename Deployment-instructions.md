...
```
5. Make the second instance a Jenkins agent (how to create a Jenkins agent scribe): [link](https://scribehow.com/shared/Step-by-step_Guide_Creating_an_Agent_in_Jenkins__xeyUT01pSAiWXC3qN42q5w)
