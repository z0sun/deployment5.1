...
# Set up database
#engine = create_engine('mysql://admin:user12345@mydata01.ctqgxnjn9p5c.us-east-1.rds.amazonaws.com:3306/bankingdb',connect_args={'check_same_thread': False},echo=True)
#Base.metadata.bind = engine
#db = scoped_session(sessionmaker(bind=engine))
# Set up database
DATABASE_URL = 'mysql+mysqldb://admin:user12345@mydata01.ctqgxnjn9p5c.us-east-1.rds.amazonaws.com:3306/bankingdb?charset=utf8mb4'
